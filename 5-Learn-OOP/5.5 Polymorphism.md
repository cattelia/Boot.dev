...
- `==`: <a href="https://docs.python.org/3/reference/datamodel.html#object.__eq__">eq</a>
- `>`: <a href="https://docs.python.org/3/reference/datamodel.html#object.__gt__">gt</a>
- `<`: <a href="https://docs.python.org/3/reference/datamodel.html#object.__lt__">lt</a>
...
List comprehensions vs `.index()` lookup.
